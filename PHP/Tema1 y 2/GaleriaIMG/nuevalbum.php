      ...
      <ul class="nav nav-collapse pull-right">
        <?php
          if($_SESSION['user'] == "admin" && $_SESSION['password']=="admin123"){
            ...
            <li><a href="nuevalbum.php" class="active">Nuevo Album</a></li>
...
<div class="container profile">
    ...
    <div class="span5">
      ...
      <?php
       ...
       ?>
       <form  action="carregaralbum.php" method="post" enctype="multipart/form-data">
         <label for="album">Nombre del nuevo Album</label>
         <input type="name" name="album" id="albums"> <br />
